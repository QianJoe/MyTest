...
NSString * const INSTEADTAKETABLEVIEWCELLID = @"INSTEADTAKETABLEVIEWCELLID";

@interface JQInsteadTakeTableViewCell ()
...
@implementation JQInsteadTakeTableViewCell
