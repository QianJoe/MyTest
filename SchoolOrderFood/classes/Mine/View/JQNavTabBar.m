...
- (void)viewConfig {
    ...
    _navgationTabBar = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 20, SCREENW - 10, 44)];
    _navgationTabBar.backgroundColor = [UIColor clearColor];
    _navgationTabBar.showsHorizontalScrollIndicator = NO;
    _navgationTabBar.panGestureRecognizer.delaysTouchesBegan = YES;
